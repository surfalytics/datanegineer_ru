...
Данные контент хостится в [репозитории](https://github.com/surfalytics/dataengineer_ru) и контент можно добавлять через Pull Request. В данный момент формируется список участников и модероторов, которые могу добавлять контент и редактировать существующий.
